/**
 * Experiment App Component - 실험용 수정 작업용
 *
...
export function ExperimentApp({ onNavigate }: ExperimentAppProps) {
  /**
  ...
  const connectConversation = useCallback(async () => {
    ...
    client.sendUserMessageContent([
      {
        type: `input_text`,
        text: `Hello! This is the experimental version!`,
   ...
   */
  return (
    <div data-component="ConsolePage" className="experiment-app">
      <div className="content-top">
        <div className="content-title">
          <img src="/openai-logomark.svg" />
          <span>translation dictation (실험용) 🧪</span>
        </div>
      ...
      <div className="content-main">
        <div className="content-logs">
          <div className="content-block translations">
            ...
            <div className="content-block-title">translations (실험용)</div>
